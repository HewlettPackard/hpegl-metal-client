...
package client
// DiskPartition Parition to be created on the host.
type DiskPartition struct {
	...
	// StartOffset is the offset from the start of the disk to the first partition,  if zero a default of 1MiB (2048 sectors) will be used, units bytes.
