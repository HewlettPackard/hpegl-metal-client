...
package client
// UpdateHostConnection struct for UpdateHostConnection
type UpdateHostConnection struct {
	Name string `json:"Name,omitempty"`
	Ports []UpdateHostServerPort `json:"Ports,omitempty"`
	...
	Networks []UpdateHostNetworkConnection `json:"Networks,omitempty"`
}
