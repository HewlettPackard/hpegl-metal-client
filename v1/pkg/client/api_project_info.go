...
// ProjectInfoApiService ProjectInfoApi service
type ProjectInfoApiService service
...
@return []ProjectsInfo
*/
func (a *ProjectInfoApiService) List(ctx _context.Context) ([]ProjectsInfo, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/project-info"
