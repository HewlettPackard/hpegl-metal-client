...
@return UsageReport
*/
func (a *UsageReportsApiService) Get(ctx _context.Context, start string, localVarOptionals *UsageReportsApiGetOpts) (UsageReport, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  UsageReport
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/usage-reports"
