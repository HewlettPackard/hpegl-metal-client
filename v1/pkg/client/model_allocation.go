...
type Allocation struct {
	// Type of the resource the allocation information is listed for. It is either Server or Volume
	...
	// Server instance type or volume type
	InstanceType string `json:"InstanceType,omitempty"`
	// If the resource type is Servers, it is available number of servers.  If resource type is volume, it is available storage space in TB
