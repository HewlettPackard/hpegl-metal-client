...
**Labels** | **map[string]string** | The map of service specified label name to label value for this volume. Setting this field is restricted by role. | [optional] 
**UserLabels** | **map[string]string** | The map of user specified label name to label value for this volume. | [optional] 
