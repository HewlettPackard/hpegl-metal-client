...
package client
// NetworkKind Describes the type of network that implies the level of isolation associated  with the network 
type NetworkKind string

// List of NetworkKind
const (
	NETWORKKIND_SHARED NetworkKind = "Shared"
	NETWORKKIND_PRIVATE NetworkKind = "Private"
	NETWORKKIND_CUSTOM NetworkKind = "Custom"
)
