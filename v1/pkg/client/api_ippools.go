...
@return IpPool
*/
func (a *IppoolsApiService) Update(ctx _context.Context, ippoolId string, ipPoolUpdate IpPoolUpdate) (IpPool, *_nethttp.Response, error) {
	var (
