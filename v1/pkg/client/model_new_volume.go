...
type NewVolume struct {
	...
	// The map of service specified label name to label value for this volume. Setting this field is restricted by role.
	Labels map[string]string `json:"Labels,omitempty"`
	// The map of user specified label name to label value for this volume.
