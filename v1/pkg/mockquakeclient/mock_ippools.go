...
func (m *MockIPPoolsAPI) Update(ctx context.Context, ippoolId string, updateIpPool client.UpdateIpPool) (client.IpPool, *http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, ippoolId, updateIpPool)
	ret0, _ := ret[0].(client.IpPool)
	ret1, _ := ret[1].(*http.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockIPPoolsAPIMockRecorder) Update(ctx, ippoolId, updateIpPool interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockIPPoolsAPI)(nil).Update), ctx, ippoolId, updateIpPool)
}
