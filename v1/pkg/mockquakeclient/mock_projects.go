...
func (m *MockProjectsAPI) Delete(ctx context.Context, projectId string, localVarOptionals *client.ProjectsApiDeleteOpts) (*http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, projectId, localVarOptionals)
...
func (mr *MockProjectsAPIMockRecorder) Delete(ctx, projectId, localVarOptionals interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockProjectsAPI)(nil).Delete), ctx, projectId, localVarOptionals)
}

// GetByID mocks base method.
func (m *MockProjectsAPI) GetByID(ctx context.Context, projectId string, localVarOptionals *client.ProjectsApiGetByIDOpts) (client.Project, *http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByID", ctx, projectId, localVarOptionals)
	ret0, _ := ret[0].(client.Project)
	ret1, _ := ret[1].(*http.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockProjectsAPIMockRecorder) GetByID(ctx, projectId, localVarOptionals interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByID", reflect.TypeOf((*MockProjectsAPI)(nil).GetByID), ctx, projectId, localVarOptionals)
}
...
func (m *MockProjectsAPI) Update(ctx context.Context, projectId string, updateProject client.UpdateProject, localVarOptionals *client.ProjectsApiUpdateOpts) (client.Project, *http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, projectId, updateProject, localVarOptionals)
	ret0, _ := ret[0].(client.Project)
	ret1, _ := ret[1].(*http.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockProjectsAPIMockRecorder) Update(ctx, projectId, updateProject, localVarOptionals interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockProjectsAPI)(nil).Update), ctx, projectId, updateProject, localVarOptionals)
}
